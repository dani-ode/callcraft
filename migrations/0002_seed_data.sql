...
('ver_01HZX01SPEC0000000001', 'spc_01HZX01SPEC0000000001', 1, '{"properties": {"image": {"type": "string"}}}'::jsonb, '{"properties": {"document_type": {"type": "string", "required": true}, "full_name": {"type": "string", "required": true}}}'::jsonb, 'Analisis dokumen identitas resmi yang diunggah (KTP, SIM, atau Paspor). Pilih 1 tool_call yang paling sesuai.', '01HZX01MODEL00000000000001', true, 'gemini-3.6-flash', '{"enabled": true, "toolChoice": "auto", "tools": [{"name": "extract_indonesian_ktp_identity", "description": "Ekstraksi data terstruktur KTP Indonesia"}, {"name": "extract_driver_license_permit", "description": "Ekstraksi SIM"}, {"name": "extract_republic_indonesia_passport", "description": "Ekstraksi Paspor RI"}]}'::jsonb),
...
('ver_01HZX01SPEC0000000003', 'spc_01HZX01SPEC0000000003', 1, '{"properties": {"image": {"type": "string"}}}'::jsonb, '{"properties": {"patient_name": {"type": "string", "required": true}, "doctor_name": {"type": "string", "required": true}}}'::jsonb, 'Analisis dokumen medis/kesehatan yang diunggah.', '01HZX01MODEL00000000000001', true, 'gemini-3.6-flash', '{"enabled": true, "toolChoice": "auto", "tools": [{"name": "extract_doctor_prescription", "description": "Ekstraksi resep dokter"}, {"name": "extract_medical_lab_result", "description": "Ekstraksi laporan lab medis"}, {"name": "extract_clinical_discharge_resume", "description": "Ekstraksi resume medis"}]}'::jsonb)
