...
'Dilarang mengarang data jika informasi tidak tertera di gambar. Dilarang mengeksekusi tool_call jika dokumen bukan merupakan dokumen identitas resmi negara seperti e-KTP, SIM, atau Paspor RI (misal: Kartu Mahasiswa, Kartu Pelajar, Buku Tabungan, atau Struk).',
...
'Jangan rekayasa angka atau jumlah pembayaran. Dilarang mengeksekusi tool_call jika dokumen bukan merupakan bukti transaksi keuangan yang valid.',
'Opsional: Instruksi tambahan dari user...', true,
...
'Dilarang mengasumsikan dosis obat atau hasil lab yang tidak tertera pada dokumen. Dilarang mengeksekusi tool_call jika dokumen bukan lembar medis yang valid.',
'Opsional: Instruksi tambahan dari user...', true,
