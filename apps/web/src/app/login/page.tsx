  ...
  useEffect(() => {
    ...
    if (errorParam) {
      if (errorParam === "google_cancelled" || errorParam === "access_denied") {
        setError("Otorisasi Google dibatalkan.");
        ...
        setError("Akun Google ini terhubung ke akun yang dinonaktifkan.");
      } else {
        setError(`Autentikasi Google gagal (${errorParam}).`);
      }
    }
  }, [searchParams]);
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="glass-panel p-8 rounded-3xl border border-[#8a715e]/20 dark:border-[#edd6bb]/20 shadow-2xl space-y-6">
          ...
          >
            ...
            <span>{googleLoading ? "Mengarahkan ke Google..." : "Lanjutkan dengan Google"}</span>
          </button>
